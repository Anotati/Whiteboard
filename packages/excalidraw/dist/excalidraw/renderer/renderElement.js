...
export const getRenderOpacity = (element, containingFrame, elementsPendingErasure, pendingNodes) => {
...
export const renderElement = (element, elementsMap, allElementsMap, rc, context, renderConfig, appState) => {
    context.globalAlpha = getRenderOpacity(element, getContainingFrame(element, elementsMap), renderConfig.elementsPendingErasure, renderConfig.pendingFlowchartNodes);
    switch (element.type) {
        case "magicframe":
        case "frame": {
