import { base64ToArrayBuffer, stringToBase64, toByteString, } from "../data/encode";
import { LOCAL_FONT_PROTOCOL } from "./metadata";
import loadWoff2 from "./wasm/woff2.loader";
import loadHbSubset from "./wasm/hb-subset.loader";
export const UNPKG_FALLBACK_URL = `https://unpkg.com/${import.meta.env.VITE_PKG_NAME
    ...
    async getContent(codePoints) {
        ...
        while (i < this.urls.length) {
            ...
            if (url.protocol === "data:") {
                ...
                const base64 = await ExcalidrawFont.subsetGlyphsByCodePoints(arrayBuffer, codePoints);
                return base64;
            }
            try {
