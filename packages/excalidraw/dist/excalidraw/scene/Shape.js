        ...
        case "triangle_outline": {
            ...
            return [
                generator.polygon([
                    ...
                    ...options,
                    fill: arrowhead === "triangle_outline"
                        ? canvasBackgroundColor
                        : element.strokeColor,
                    fillStyle: "solid",
        ...
        case "diamond_outline": {
            ...
            return [
                generator.polygon([
                    ...
                    ...options,
                    fill: arrowhead === "diamond_outline"
                        ? canvasBackgroundColor
                        : element.strokeColor,
                    fillStyle: "solid",
                    roughness: Math.min(1, options.roughness || 0),
...
export const _generateElementShape = (element, generator, { isExporting, canvasBackgroundColor, embedsValidationStatus, }) => {
    switch (element.type) {
        ...
        default: {
            assertNever(element, `generateElementShape(): Unimplemented type ${element?.type}`);
            return null;
        }
    }
};
