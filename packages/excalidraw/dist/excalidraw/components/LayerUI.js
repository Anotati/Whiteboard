...
const LayerUI = ({ actionManager, appState, files, setAppState, elements, canvas, onLockToggle, onHandToolToggle, onPenModeToggle, showExitZenModeBtn, renderTopRightUI, renderCustomStats, UIOptions, onExportImage, renderWelcomeScreen, children, app, isCollaborating, }) => {
    ...
    const renderFixedSideContainer = () => {
        ...
        return (_jsx(FixedSideContainer, { side: "left", children: _jsxs("div", { className: "", children: [_jsxs(Stack.Row, { gap: 6, className: clsx(""), children: [renderCanvasActions(), shouldRenderSelectedShapeActions && renderSelectedShapeActions()] }), !appState.viewModeEnabled && (_jsx(Section, { heading: "shapes", className: "", children: (heading) => (_jsxs("div", { children: [renderWelcomeScreen && (_jsx(tunnels.WelcomeScreenToolbarHintTunnel.Out, {})), _jsx(Stack.Row, { gap: 4, children: _jsxs(Stack.Row, { gap: 1, className: clsx("", {
                                            "zen-mode": appState.zenModeEnabled,
                                        }), children: [_jsxs(Island, { padding: 1, style: {
                                                    marginTop: 60,
                                                    marginLeft: 7,
                                                }, className: clsx(".App-toolbar__tools", {
                                                    "zen-mode": appState.zenModeEnabled,
                                                }), children: [_jsx(HintViewer, { appState: appState, isMobile: device.editor.isMobile, device: device, app: app }), heading, _jsx(PenModeButton, { zenModeEnabled: appState.zenModeEnabled, checked: appState.penMode, onChange: () => onPenModeToggle(null), title: t("toolBar.penMode"), penDetected: appState.penDetected }), _jsx(LockButton, { checked: appState.activeTool.locked, onChange: onLockToggle, title: t("toolBar.lock") }), _jsx("div", { className: "App-toolbar__divider" }), _jsx(HandButton, { checked: isHandToolActive(appState), onChange: () => onHandToolToggle(), title: t("toolBar.hand"), isMobile: true }), _jsx(ShapesSwitcher, { appState: appState, activeTool: appState.activeTool, UIOptions: UIOptions, app: app })] }), isCollaborating && (_jsx(Island, { style: {
                                                    marginLeft: 8,
                                                    alignSelf: "center",
                                                    height: "fit-content",
    ...
    const layerUIJSX = (_jsxs(_Fragment, { children: [children, _jsx(DefaultMainMenu, { UIOptions: UIOptions }), _jsx(DefaultOverwriteConfirmDialog, {}), appState.openDialog?.name === "ttd" && _jsx(TTDDialog, { __fallback: true }), appState.isLoading && _jsx(LoadingMessage, { delay: 250 }), appState.errorMessage && (_jsx(ErrorDialog, { onClose: () => setAppState({ errorMessage: null }), children: appState.errorMessage })), eyeDropperState && !device.editor.isMobile && (_jsx(EyeDropper, { colorPickerType: eyeDropperState.colorPickerType, onCancel: () => {
